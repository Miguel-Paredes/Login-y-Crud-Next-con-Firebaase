    ...
    <div className="min-h-screen flex items-center justify-center">
      <div className="w-full">
        ...
        <p className="text-center mt-2">
          ¿Has olvidado tu contraseña? Descuida aqui estamos para ayudarte
        </p>
        <div className="flex justify-center items-center text-center">
          <form
            onSubmit={handleSubmit(onSubmit)}
            className="p-12.5 px-14.5 shadow-lg rounded-xl text-center w-4/5 md:w-1/2 bg-white"
          >
            <div className="flex flex-col text-left mb-4" id="input-group">
              ...
              {!isLoading && (
                <>
                  <div className="flex justify-center">
                    <button className="bg-blue-400 text-white mx-2 rounded-lg hover:underline hover:bg-black hover:text-white flex text-center justify-center w-1/3">
